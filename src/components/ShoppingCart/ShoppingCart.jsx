...
const ShoppingCart = () => {
  ...
  const { productsCart, setProductsCart } = useAllDataProduct();
  ...
  useEffect(() =>{
    ...
    setProductsCart( getProductsLocalStorage );
  ...
  useEffect(() => {
    ...
    if (productsCart) {
      ...
      setNumberProductState( productsCart.length );
      const prices = productsCart.map( product => product.precio * product.amount );
    ...
    <div className='container-shopping-card'>
      ...
      { 
        openCartState 
          ? 
            <>
              <div className="container-buttons-transaction">
                <button 
                ...
                <button 
                  ...
                  onClick={ () => placeAnOrderOnWhatsApp( productsCart ) }
                  disabled={!openCartState} 
                >
                  Hacer pedido
                </button>
